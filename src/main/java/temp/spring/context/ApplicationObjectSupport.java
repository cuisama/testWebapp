...
public abstract class ApplicationObjectSupport implements ApplicationContextAware {
	...
	public final void setApplicationContext(ApplicationContext context) throws BeansException {
		if (context == null && !isContextRequired()) {
			...
			this.messageSourceAccessor = new org.springframework.context.support.MessageSourceAccessor(context);
	 ...
	 * @throws IllegalStateException if not running in an ApplicationContext
	 */
	protected final org.springframework.context.support.MessageSourceAccessor getMessageSourceAccessor() throws IllegalStateException {
