...
public class FailFastProblemReporter implements ProblemReporter {
	...
	/**
	 * Throws a {@link org.springframework.beans.factory.parsing.BeanDefinitionParsingException} detailing the error
	 * that has occurred.
	 * @param problem the source of the error
	 */
	@Override
	public void fatal(Problem problem) {
		throw new org.springframework.beans.factory.parsing.BeanDefinitionParsingException(problem);
	}
