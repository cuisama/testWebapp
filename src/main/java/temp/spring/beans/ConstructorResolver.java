...
class ConstructorResolver {
	 ...
	 */
	public ConstructorResolver(org.springframework.beans.factory.support.AbstractAutowireCapableBeanFactory beanFactory) {
	...
	public BeanWrapper autowireConstructor(final String beanName, final RootBeanDefinition mbd,
		...
		if (constructorToUse == null) {
			...
			org.springframework.beans.factory.support.AutowireUtils.sortConstructors(candidates);
	...
	public BeanWrapper instantiateUsingFactoryMethod(
		...
		if (factoryMethodToUse == null || argsToUse == null) {
			...
			org.springframework.beans.factory.support.AutowireUtils.sortFactoryMethods(candidates);
