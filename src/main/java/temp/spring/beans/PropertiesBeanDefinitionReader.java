...
public class PropertiesBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	protected void registerBeanDefinition(String beanName, Map<?, ?> map, String prefix, String resourceDescription)
		...
		String parent = null;
		String scope = org.springframework.beans.factory.support.GenericBeanDefinition.SCOPE_SINGLETON;
		...
		for (Map.Entry<?, ?> entry : map.entrySet()) {
			...
			if (key.startsWith(prefix + SEPARATOR)) {
				...
				if (CLASS_KEY.equals(property)) {
					...
					// Spring 1.2 style
					String val = StringUtils.trimWhitespace((String) entry.getValue());
					scope = ((val == null || TRUE_VALUE.equals(val) ? org.springframework.beans.factory.support.GenericBeanDefinition.SCOPE_SINGLETON :
