...
class TypeConverterDelegate {
	 ...
	 */
	public TypeConverterDelegate(org.springframework.beans.PropertyEditorRegistrySupport propertyEditorRegistry) {
				...
				if (String.class == requiredType && ClassUtils.isPrimitiveOrWrapper(convertedValue.getClass())) {
					...
					if (conversionAttemptEx == null && !requiredType.isInterface() && !requiredType.isEnum()) {
						try {
							...
							return org.springframework.beans.BeanUtils.instantiateClass(strCtor, convertedValue);
						}
	...
	private String buildIndexedPropertyName(String propertyName, int index) {
		return (propertyName != null ?
				propertyName + org.springframework.beans.PropertyAccessor.PROPERTY_KEY_PREFIX + index + org.springframework.beans.PropertyAccessor.PROPERTY_KEY_SUFFIX :
				null);
	}

	private String buildKeyedPropertyName(String propertyName, Object key) {
		return (propertyName != null ?
				propertyName + org.springframework.beans.PropertyAccessor.PROPERTY_KEY_PREFIX + key + PropertyAccessor.PROPERTY_KEY_SUFFIX :
				null);
	}
