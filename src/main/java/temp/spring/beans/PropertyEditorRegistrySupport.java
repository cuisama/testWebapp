 ...
 */
public class PropertyEditorRegistrySupport implements org.springframework.beans.PropertyEditorRegistry {
	...
	public boolean hasCustomEditorForElement(Class<?> elementType, String propertyPath) {
		if (propertyPath != null && this.customEditorsForPath != null) {
			for (Map.Entry<String, CustomEditorHolder> entry : this.customEditorsForPath.entrySet()) {
				if (org.springframework.beans.PropertyAccessorUtils.matchesProperty(entry.getKey(), propertyPath)) {
	...
	protected void copyCustomEditorsTo(PropertyEditorRegistry target, String nestedProperty) {
		String actualPropertyName =
				(nestedProperty != null ? org.springframework.beans.PropertyAccessorUtils.getPropertyName(nestedProperty) : null);
		if (this.customEditors != null) {
	...
	private void addStrippedPropertyPaths(List<String> strippedPaths, String nestedPath, String propertyPath) {
		int startIndex = propertyPath.indexOf(org.springframework.beans.PropertyAccessor.PROPERTY_KEY_PREFIX_CHAR);
		if (startIndex != -1) {
