 ...
 * during {@link org.springframework.beans.factory.BeanFactory} bootstrap. This interface can be implemented by
 * singleton beans in order to perform some initialization after the regular
 * singleton instantiation algorithm, avoiding side effects with accidental early
 * initialization (e.g. from {@link org.springframework.beans.factory.ListableBeanFactory#getBeansOfType} calls).
 * In that sense, it is an alternative to {@link org.springframework.beans.factory.InitializingBean} which gets
 ...
 * and is being honored by standalone {@link org.springframework.beans.factory.ListableBeanFactory} implementations,
