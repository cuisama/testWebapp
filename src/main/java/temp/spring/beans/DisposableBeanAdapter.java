...
class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
		...
		if (destroyMethodName != null && !(this.invokeDisposableBean && "destroy".equals(destroyMethodName)) &&
			...
			if (this.destroyMethod == null) {
				if (beanDefinition.isEnforceDestroyMethod()) {
					throw new org.springframework.beans.factory.support.BeanDefinitionValidationException("Couldn't find a destroy method named '" +
				...
				if (paramTypes.length > 1) {
					throw new org.springframework.beans.factory.support.BeanDefinitionValidationException("Method '" + destroyMethodName + "' of bean '" +
	...
	private String inferDestroyMethodIfNecessary(Object bean, RootBeanDefinition beanDefinition) {
		...
		if (org.springframework.beans.factory.support.AbstractBeanDefinition.INFER_METHOD.equals(destroyMethodName) ||
