...
public abstract class BeanFactoryUtils {
	...
	public static boolean isFactoryDereference(String name) {
		return (name != null && name.startsWith(org.springframework.beans.factory.BeanFactory.FACTORY_BEAN_PREFIX));
	}
	...
	public static String transformedBeanName(String name) {
		...
		while (beanName.startsWith(org.springframework.beans.factory.BeanFactory.FACTORY_BEAN_PREFIX)) {
			beanName = beanName.substring(org.springframework.beans.factory.BeanFactory.FACTORY_BEAN_PREFIX.length());
		}
		return beanName;
	}
