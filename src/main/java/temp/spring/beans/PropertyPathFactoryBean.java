	...
	public Object getObject() throws BeansException {
		...
		if (target != null) {
			if (logger.isWarnEnabled() && this.targetBeanName != null &&
					this.beanFactory instanceof org.springframework.beans.factory.config.ConfigurableBeanFactory &&
					((org.springframework.beans.factory.config.ConfigurableBeanFactory) this.beanFactory).isCurrentlyInCreation(this.targetBeanName)) {
