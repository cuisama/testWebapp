 ...
 * available as property "sort". By default, a {@link org.springframework.beans.support.MutableSortDefinition} instance
...
public class PagedListHolder<E> implements Serializable {
	...
	public PagedListHolder(List<E> source) {
		this(source, new org.springframework.beans.support.MutableSortDefinition(true));
	}
	...
	protected SortDefinition copySortDefinition(SortDefinition sort) {
		return new org.springframework.beans.support.MutableSortDefinition(sort);
	}
