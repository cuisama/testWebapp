...
public class Problem {
	 ...
	 */
	public Problem(String message, org.springframework.beans.factory.parsing.Location location) {
	 ...
	 * @param location the location within a bean configuration source that triggered the error
	 */
	public Problem(String message, org.springframework.beans.factory.parsing.Location location, org.springframework.beans.factory.parsing.ParseState parseState) {
	 ...
	 * @param location the location within a bean configuration source that triggered the error
	 */
	public Problem(String message, org.springframework.beans.factory.parsing.Location location, org.springframework.beans.factory.parsing.ParseState parseState, Throwable rootCause) {
