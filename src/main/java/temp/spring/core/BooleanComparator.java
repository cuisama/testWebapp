...
public class BooleanComparator implements Comparator<Boolean>, Serializable {
	 ...
	 */
	public static final org.springframework.util.comparator.BooleanComparator TRUE_LOW = new org.springframework.util.comparator.BooleanComparator(true);

	/**
	 * A shared default instance of this comparator,
	 * treating {@code true} higher than {@code false}.
	 */
	public static final org.springframework.util.comparator.BooleanComparator TRUE_HIGH = new org.springframework.util.comparator.BooleanComparator(false);
	...
	public boolean equals(Object obj) {
		return (this == obj ||
				(obj instanceof org.springframework.util.comparator.BooleanComparator && (this.trueLow == ((org.springframework.util.comparator.BooleanComparator) obj).trueLow)));
	}
