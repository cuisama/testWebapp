...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
	...
	public LinkedCaseInsensitiveMap(int initialCapacity, Locale locale) {
		this.targetMap = new LinkedHashMap<String, V>(initialCapacity) {
			...
			public boolean containsKey(Object key) {
				return org.springframework.util.LinkedCaseInsensitiveMap.this.containsKey(key);
			}
			@Override
			protected boolean removeEldestEntry(Map.Entry<String, V> eldest) {
				boolean doRemove = org.springframework.util.LinkedCaseInsensitiveMap.this.removeEldestEntry(eldest);
				if (doRemove) {
	...
	private LinkedCaseInsensitiveMap(org.springframework.util.LinkedCaseInsensitiveMap<V> other) {
	...
	public org.springframework.util.LinkedCaseInsensitiveMap<V> clone() {
		return new org.springframework.util.LinkedCaseInsensitiveMap<>(this);
	}
