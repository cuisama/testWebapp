...
public class VfsResource extends AbstractResource {
	...
	public Resource createRelative(String relativePath) throws IOException {
		if (!relativePath.startsWith(".") && relativePath.contains("/")) {
			try {
				return new org.springframework.core.io.VfsResource(VfsUtils.getChild(this.resource, relativePath));
			}
		...
		return new org.springframework.core.io.VfsResource(VfsUtils.getRelative(new URL(getURL(), relativePath)));
	}
	...
	public boolean equals(Object obj) {
		return (obj == this || (obj instanceof org.springframework.core.io.VfsResource && this.resource.equals(((org.springframework.core.io.VfsResource) obj).resource)));
	}
