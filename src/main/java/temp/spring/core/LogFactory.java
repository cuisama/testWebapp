 ...
 * providing just the two common static {@link org.apache.commons.logging.Log} lookup methods.
...
public abstract class LogFactory {
	...
	static {
		ClassLoader cl = org.apache.commons.logging.LogFactory.class.getClassLoader();
		try {
			// Try Log4J 2.x API
	...
	public static org.apache.commons.logging.LogFactory getFactory() {
		return new org.apache.commons.logging.LogFactory() {};
	}
	...
	private static class Log4jDelegate {
		...
		public static org.apache.commons.logging.Log createLog(String name) {
	...
	private static class Slf4jDelegate {
		...
		public static org.apache.commons.logging.Log createLocationAwareLog(String name) {
	...
	private static class Log4jLog implements org.apache.commons.logging.Log, Serializable {
	...
	@SuppressWarnings("serial")
	private static class Slf4jLog<T extends Logger> implements org.apache.commons.logging.Log, Serializable {
