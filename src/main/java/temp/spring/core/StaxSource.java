...
class StaxSource extends SAXSource {
	...
	StaxSource(XMLStreamReader streamReader) {
		super(new org.springframework.util.xml.StaxStreamXMLReader(streamReader), new InputSource());
	...
	StaxSource(XMLEventReader eventReader) {
		super(new org.springframework.util.xml.StaxEventXMLReader(eventReader), new InputSource());
	 ...
	 * @see org.springframework.util.xml.StaxSource#StaxSource(XMLEventReader)
	 */
