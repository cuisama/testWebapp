 ...
 * @see MimeTypeUtils
 */
public class MimeType implements Comparable<org.springframework.util.MimeType>, Serializable {
	 ...
	 * @since 4.3
	 */
	public MimeType(org.springframework.util.MimeType other, Charset charset) {
	 ...
	 * @throws IllegalArgumentException if any of the parameters contains illegal characters
	 */
	public MimeType(org.springframework.util.MimeType other, Map<String, String> parameters) {
	 ...
	 */
	public boolean includes(org.springframework.util.MimeType other) {
		if (other == null) {
			return false;
		}
	 ...
	 * {@code false} otherwise
	 */
	public boolean isCompatibleWith(org.springframework.util.MimeType other) {
		if (other == null) {
			return false;
		}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof org.springframework.util.MimeType)) {
			return false;
		}
		org.springframework.util.MimeType otherType = (org.springframework.util.MimeType) other;
	 ...
	 * @since 4.2
	 */
	private boolean parametersAreEqual(org.springframework.util.MimeType other) {
	 ...
	 */
	@Override
	public int compareTo(org.springframework.util.MimeType other) {
	 ...
	 */
	public static org.springframework.util.MimeType valueOf(String value) {
	...
	public static class SpecificityComparator<T extends org.springframework.util.MimeType> implements Comparator<T> {
