...
/**
 * A simple {@link org.springframework.util.backoff.BackOff} implementation that provides a fixed interval
...
public class FixedBackOff implements BackOff {
	...
	private class FixedBackOffExecution implements BackOffExecution {
		...
		public String toString() {
			...
			sb.append("interval=").append(org.springframework.util.backoff.FixedBackOff.this.interval);
			String attemptValue = (org.springframework.util.backoff.FixedBackOff.this.maxAttempts == Long.MAX_VALUE ?
					"unlimited" : String.valueOf(org.springframework.util.backoff.FixedBackOff.this.maxAttempts));
