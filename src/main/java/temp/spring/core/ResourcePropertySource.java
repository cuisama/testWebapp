...
public class ResourcePropertySource extends PropertiesPropertySource {
	...
	/**
	 * Return a potentially adapted variant of this {@link org.springframework.core.io.support.ResourcePropertySource},
	 * overriding the previously given (or derived) name with the specified name.
	 * @since 4.0.4
	 */
	public org.springframework.core.io.support.ResourcePropertySource withName(String name) {
		...
		if (this.resourceName != null) {
			if (this.resourceName.equals(name)) {
				return new org.springframework.core.io.support.ResourcePropertySource(this.resourceName, null, this.source);
			}
			else {
				return new org.springframework.core.io.support.ResourcePropertySource(name, this.resourceName, this.source);
			}
		}
		else {
			// Current name is resource name -> preserve it in the extra field...
			return new org.springframework.core.io.support.ResourcePropertySource(name, this.name, this.source);
		}
	}
