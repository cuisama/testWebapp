...
public abstract class AnnotationUtils {
	...
	static void handleIntrospectionFailure(AnnotatedElement element, Throwable ex) {
		...
		if (loggerToUse == null) {
			loggerToUse = LogFactory.getLog(org.springframework.core.annotation.AnnotationUtils.class);
			logger = loggerToUse;
		}
	...
	private static class AnnotationCollector<A extends Annotation> {
		...
		private List<A> getValue(AnnotatedElement element, Annotation annotation) {
			try {
				...
				for (A anno : (A[]) org.springframework.core.annotation.AnnotationUtils.getValue(annotation)) {
