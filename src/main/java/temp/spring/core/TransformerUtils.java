...
/**
 * Contains common behavior relating to {@link Transformer Transformers}, and the
...
public abstract class TransformerUtils {
	...
	/**
	 * The indent amount of characters if {@link #enableIndenting(Transformer) indenting is enabled}.
	 * <p>Defaults to "2".
	 */
	public static final int DEFAULT_INDENT_AMOUNT = 2;

	/**
	 * Enable indenting for the supplied {@link Transformer}. <p>If the underlying XSLT engine is
