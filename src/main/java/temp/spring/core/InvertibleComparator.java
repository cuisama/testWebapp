...
public class InvertibleComparator<T> implements Comparator<T>, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof org.springframework.util.comparator.InvertibleComparator)) {
			return false;
		}
		org.springframework.util.comparator.InvertibleComparator<T> other = (org.springframework.util.comparator.InvertibleComparator<T>) obj;
