...
public abstract class DigestUtils {
	...
	private static byte[] digest(String algorithm, InputStream inputStream) throws IOException {
		...
		if (inputStream instanceof org.springframework.util.UpdateMessageDigestInputStream){
			((org.springframework.util.UpdateMessageDigestInputStream) inputStream).updateMessageDigest(messageDigest);
