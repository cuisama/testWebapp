 ...
 * to a List, then delegates to {@link org.springframework.core.convert.support.CollectionToStringConverter} to perform
...
final class ArrayToStringConverter implements ConditionalGenericConverter {
	...
	public ArrayToStringConverter(ConversionService conversionService) {
		this.helperConverter = new org.springframework.core.convert.support.CollectionToStringConverter(conversionService);
	}
