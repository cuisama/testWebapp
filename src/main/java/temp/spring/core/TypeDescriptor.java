...
public class TypeDescriptor implements Serializable {
	...
	private static final Map<Class<?>, org.springframework.core.convert.TypeDescriptor> commonTypesCache = new HashMap<>(18);
	 ...
	 * {@link MethodParameter} or {@link Type} depending on how the {@link org.springframework.core.convert.TypeDescriptor}
	...
	/**
	 * Narrows this {@link org.springframework.core.convert.TypeDescriptor} by setting its type to the class of the
	 * provided value.
	 ...
	 */
	public org.springframework.core.convert.TypeDescriptor narrow(Object value) {
		if (value == null) {
			return this;
		}
		ResolvableType narrowed = ResolvableType.forType(value.getClass(), getResolvableType());
		return new org.springframework.core.convert.TypeDescriptor(narrowed, value.getClass(), getAnnotations());
	}

	/**
	 * Cast this {@link org.springframework.core.convert.TypeDescriptor} to a superclass or implemented interface
	 ...
	 * @since 3.2
	 */
	public org.springframework.core.convert.TypeDescriptor upcast(Class<?> superType) {
		if (superType == null) {
			return null;
		}
		Assert.isAssignable(superType, getType());
		return new org.springframework.core.convert.TypeDescriptor(getResolvableType().as(superType), superType, getAnnotations());
	}
	 ...
	 * @see #getObjectType()
	 */
	public boolean isAssignableTo(org.springframework.core.convert.TypeDescriptor typeDescriptor) {
	...
	private boolean isNestedAssignable(org.springframework.core.convert.TypeDescriptor nestedTypeDescriptor, org.springframework.core.convert.TypeDescriptor otherNestedTypeDescriptor) {
	...
	public org.springframework.core.convert.TypeDescriptor getElementTypeDescriptor() {
		if (getResolvableType().isArray()) {
			return new org.springframework.core.convert.TypeDescriptor(getResolvableType().getComponentType(), null, getAnnotations());
		}
	 ...
	 * @see #narrow(Object)
	 */
	public org.springframework.core.convert.TypeDescriptor elementTypeDescriptor(Object element) {
	...
	/**
	 * If this type is a {@link Map}, creates a mapKey {@link org.springframework.core.convert.TypeDescriptor}
	 ...
	 * @see #narrow(Object)
	 */
	public org.springframework.core.convert.TypeDescriptor getMapKeyTypeDescriptor(Object mapKey) {
	...
	/**
	 * If this type is a {@link Map}, creates a mapValue {@link org.springframework.core.convert.TypeDescriptor}
	 ...
	 * @see #narrow(Object)
	 */
	public org.springframework.core.convert.TypeDescriptor getMapValueTypeDescriptor(Object mapValue) {
		return narrow(mapValue, getMapValueTypeDescriptor());
	}

	private org.springframework.core.convert.TypeDescriptor narrow(Object value, org.springframework.core.convert.TypeDescriptor typeDescriptor) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof org.springframework.core.convert.TypeDescriptor)) {
			return false;
		}
		org.springframework.core.convert.TypeDescriptor otherDesc = (org.springframework.core.convert.TypeDescriptor) other;
	...
	private boolean annotationsMatch(org.springframework.core.convert.TypeDescriptor otherDesc) {
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor forObject(Object source) {
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor valueOf(Class<?> type) {
		if (type == null) {
			type = Object.class;
		}
		org.springframework.core.convert.TypeDescriptor desc = commonTypesCache.get(type);
		return (desc != null ? desc : new org.springframework.core.convert.TypeDescriptor(ResolvableType.forClass(type), null, null));
	}
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor collection(Class<?> collectionType, org.springframework.core.convert.TypeDescriptor elementTypeDescriptor) {
		Assert.notNull(collectionType, "Collection type must not be null");
		if (!Collection.class.isAssignableFrom(collectionType)) {
			throw new IllegalArgumentException("Collection type must be a [java.util.Collection]");
		}
		ResolvableType element = (elementTypeDescriptor != null ? elementTypeDescriptor.resolvableType : null);
		return new org.springframework.core.convert.TypeDescriptor(ResolvableType.forClassWithGenerics(collectionType, element), null, null);
	}
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor map(Class<?> mapType, org.springframework.core.convert.TypeDescriptor keyTypeDescriptor, org.springframework.core.convert.TypeDescriptor valueTypeDescriptor) {
		...
		return new org.springframework.core.convert.TypeDescriptor(ResolvableType.forClassWithGenerics(mapType, key, value), null, null);
	}
	 ...
	 * </pre>
	 * @param elementTypeDescriptor the {@link org.springframework.core.convert.TypeDescriptor} of the array element or {@code null}
	 * @return an array {@link org.springframework.core.convert.TypeDescriptor} or {@code null} if {@code elementTypeDescriptor} is {@code null}
	 * @since 3.2.1
	 */
	public static org.springframework.core.convert.TypeDescriptor array(org.springframework.core.convert.TypeDescriptor elementTypeDescriptor) {
		if (elementTypeDescriptor == null) {
			return null;
		}
		return new org.springframework.core.convert.TypeDescriptor(ResolvableType.forArrayComponent(elementTypeDescriptor.resolvableType),
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor nested(MethodParameter methodParameter, int nestingLevel) {
		...
		return nested(new org.springframework.core.convert.TypeDescriptor(methodParameter), nestingLevel);
	}
	 ...
	 */
	public static org.springframework.core.convert.TypeDescriptor nested(Field field, int nestingLevel) {
		return nested(new org.springframework.core.convert.TypeDescriptor(field), nestingLevel);
	}
	 ...
	 * level are not of collection, array, or map types
	 */
	public static org.springframework.core.convert.TypeDescriptor nested(Property property, int nestingLevel) {
		return nested(new org.springframework.core.convert.TypeDescriptor(property), nestingLevel);
	}

	private static org.springframework.core.convert.TypeDescriptor nested(org.springframework.core.convert.TypeDescriptor typeDescriptor, int nestingLevel) {
	...
	private static org.springframework.core.convert.TypeDescriptor getRelatedIfResolvable(org.springframework.core.convert.TypeDescriptor source, ResolvableType type) {
		if (type.resolve() == null) {
			return null;
		}
		return new org.springframework.core.convert.TypeDescriptor(type, null, source.getAnnotations());
	}
	...
	private class AnnotatedElementAdapter implements AnnotatedElement, Serializable {
		...
		@Override
		public String toString() {
			return org.springframework.core.convert.TypeDescriptor.this.toString();
		}
	}
