...
public abstract class ParameterizedTypeReference<T> {
	...
	public boolean equals(Object obj) {
		return (this == obj || (obj instanceof org.springframework.core.ParameterizedTypeReference &&
				this.type.equals(((org.springframework.core.ParameterizedTypeReference<?>) obj).type)));
	}
	...
	private static Class<?> findParameterizedTypeReferenceSubclass(Class<?> child) {
		...
		else if (org.springframework.core.ParameterizedTypeReference.class == parent) {
			return child;
		}
		else {
