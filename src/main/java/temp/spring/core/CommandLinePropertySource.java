...
public abstract class CommandLinePropertySource<T> extends EnumerablePropertySource<T> {
	...
	/** The default name given to {@link org.springframework.core.env.CommandLinePropertySource} instances: {@value} */
	...
	/**
	 * Create a new {@link org.springframework.core.env.CommandLinePropertySource} having the given name
