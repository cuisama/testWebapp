...
public abstract class OrderUtils {
	...
	static {
		try {
			priorityAnnotationType = (Class<? extends Annotation>)
					ClassUtils.forName("javax.annotation.Priority", org.springframework.core.annotation.OrderUtils.class.getClassLoader());
		}
		catch (Throwable ex) {
	...
	public static Integer getOrder(Class<?> type, Integer defaultOrder) {
		Order order = org.springframework.core.annotation.AnnotationUtils.findAnnotation(type, Order.class);
		if (order != null) {
			return order.value();
		}
	...
	public static Integer getPriority(Class<?> type) {
		if (priorityAnnotationType != null) {
			Annotation priority = org.springframework.core.annotation.AnnotationUtils.findAnnotation(type, priorityAnnotationType);
			if (priority != null) {
