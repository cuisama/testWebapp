...
public class CompoundComparator<T> implements Comparator<T>, Serializable {
	...
	private final List<org.springframework.util.comparator.InvertibleComparator> comparators;
	...
	public void addComparator(Comparator<? extends T> comparator) {
		if (comparator instanceof org.springframework.util.comparator.InvertibleComparator) {
			this.comparators.add((org.springframework.util.comparator.InvertibleComparator) comparator);
		}
		else {
			this.comparators.add(new org.springframework.util.comparator.InvertibleComparator(comparator));
		}
	}
	...
	public void addComparator(Comparator<? extends T> comparator, boolean ascending) {
		this.comparators.add(new org.springframework.util.comparator.InvertibleComparator(comparator, ascending));
	}
	...
	public void setComparator(int index, Comparator<? extends T> comparator) {
		if (comparator instanceof org.springframework.util.comparator.InvertibleComparator) {
			this.comparators.set(index, (org.springframework.util.comparator.InvertibleComparator) comparator);
		}
		else {
			this.comparators.set(index, new org.springframework.util.comparator.InvertibleComparator(comparator));
		}
	}
	...
	public void setComparator(int index, Comparator<T> comparator, boolean ascending) {
		this.comparators.set(index, new org.springframework.util.comparator.InvertibleComparator<>(comparator, ascending));
	}
	...
	public void invertOrder() {
		for (org.springframework.util.comparator.InvertibleComparator comparator : this.comparators) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof org.springframework.util.comparator.CompoundComparator)) {
			return false;
		}
		org.springframework.util.comparator.CompoundComparator<T> other = (org.springframework.util.comparator.CompoundComparator<T>) obj;
