...
public class SynthesizingMethodParameter extends MethodParameter {
	 ...
	 */
	protected SynthesizingMethodParameter(org.springframework.core.annotation.SynthesizingMethodParameter original) {
		super(original);
	}
	...
	public org.springframework.core.annotation.SynthesizingMethodParameter clone() {
		return new org.springframework.core.annotation.SynthesizingMethodParameter(this);
	}
	 ...
	 * @since 5.0
	 */
	public static org.springframework.core.annotation.SynthesizingMethodParameter forExecutable(Executable executable, int parameterIndex) {
		if (executable instanceof Method) {
			return new org.springframework.core.annotation.SynthesizingMethodParameter((Method) executable, parameterIndex);
		}
		else if (executable instanceof Constructor) {
			return new org.springframework.core.annotation.SynthesizingMethodParameter((Constructor<?>) executable, parameterIndex);
		}
		else {
	 ...
	 * @since 5.0
	 */
	public static org.springframework.core.annotation.SynthesizingMethodParameter forParameter(Parameter parameter) {
