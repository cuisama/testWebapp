...
public class AnnotationMetadataReadingVisitor extends ClassMetadataReadingVisitor implements AnnotationMetadata {
	 ...
	 * @see org.springframework.core.type.classreading.AnnotationReadingVisitorUtils#getMergedAnnotationAttributes
	 */
	...
	public AnnotationVisitor visitAnnotation(final String desc, boolean visible) {
		...
		return new org.springframework.core.type.classreading.AnnotationAttributesReadingVisitor(
	...
	public AnnotationAttributes getAnnotationAttributes(String annotationName, boolean classValuesAsString) {
		AnnotationAttributes raw = org.springframework.core.type.classreading.AnnotationReadingVisitorUtils.getMergedAnnotationAttributes(
				this.attributesMap, this.metaAnnotationMap, annotationName);
		return org.springframework.core.type.classreading.AnnotationReadingVisitorUtils.convertClassValues(
	...
	public MultiValueMap<String, Object> getAllAnnotationAttributes(String annotationName, boolean classValuesAsString) {
		...
		for (AnnotationAttributes raw : attributes) {
			for (Map.Entry<String, Object> entry : org.springframework.core.type.classreading.AnnotationReadingVisitorUtils.convertClassValues(
