...
abstract class AbstractRecursiveAnnotationVisitor extends AnnotationVisitor {
	...
	public AnnotationVisitor visitAnnotation(String attributeName, String asmTypeDescriptor) {
		...
		return new org.springframework.core.type.classreading.RecursiveAnnotationAttributesVisitor(annotationType, nestedAttributes, this.classLoader);
	}

	@Override
	public AnnotationVisitor visitArray(String attributeName) {
		return new org.springframework.core.type.classreading.RecursiveAnnotationArrayVisitor(attributeName, this.attributes, this.classLoader);
	}
