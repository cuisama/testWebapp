...
public class NullSafeComparator<T> implements Comparator<T> {
	...
	public static final org.springframework.util.comparator.NullSafeComparator NULLS_LOW = new org.springframework.util.comparator.NullSafeComparator<>(true);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static final org.springframework.util.comparator.NullSafeComparator NULLS_HIGH = new org.springframework.util.comparator.NullSafeComparator<>(false);
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof org.springframework.util.comparator.NullSafeComparator)) {
			return false;
		}
		org.springframework.util.comparator.NullSafeComparator<T> other = (org.springframework.util.comparator.NullSafeComparator<T>) obj;
