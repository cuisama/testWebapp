 ...
 * @since 4.1
 * @see temp.spring.aop.AbstractAdvisingBeanPostProcessor
 * @see org.springframework.aop.framework.autoproxy.AbstractAutoProxyCreator
 */
@SuppressWarnings("serial")
public class ProxyProcessorSupport extends org.springframework.aop.framework.ProxyConfig implements Ordered, BeanClassLoaderAware, AopInfrastructureBean {
