...
public abstract class AbstractSingletonProxyFactoryBean extends ProxyConfig
	...
	public void afterPropertiesSet() {
		...
		temp.spring.aop.ProxyFactory proxyFactory = new temp.spring.aop.ProxyFactory();
	...
	/**
	 * A hook for subclasses to post-process the {@link temp.spring.aop.ProxyFactory}
	 * before creating the proxy instance with it.
	 * @param proxyFactory the AOP ProxyFactory about to be used
	 * @since 4.2
	 */
	protected void postProcessProxyFactory(temp.spring.aop.ProxyFactory proxyFactory) {
	}
