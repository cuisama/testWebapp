...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	...
	public void init() {
		...
		registerBeanDefinitionDecorator("scoped-proxy", new temp.ScopedProxyBeanDefinitionDecorator());

		// Only in 2.0 XSD: moved to context namespace as of 2.1
		registerBeanDefinitionParser("spring-configured", new temp.SpringConfiguredBeanDefinitionParser());
	}
