...
public abstract class AbstractAspectJAdvice implements Advice, org.springframework.aop.aspectj.AspectJPrecedenceInformation, Serializable {
	...
	public AbstractAspectJAdvice(
			Method aspectJAdviceMethod, AspectJExpressionPointcut pointcut, org.springframework.aop.aspectj.AspectInstanceFactory aspectInstanceFactory) {
	 ...
	 * and adds a specifically configured {@link org.springframework.aop.aspectj.AspectJAdviceParameterNameDiscoverer}.
	 */
	protected ParameterNameDiscoverer createParameterNameDiscoverer() {
		// We need to discover them, or if that fails, guess,
		// and if we can't guess with 100% accuracy, fail.
		DefaultParameterNameDiscoverer discoverer = new DefaultParameterNameDiscoverer();
		org.springframework.aop.aspectj.AspectJAdviceParameterNameDiscoverer adviceParameterNameDiscoverer =
