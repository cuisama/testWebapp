...
public class ReflectiveMethodInvocation implements ProxyMethodInvocation, Cloneable {
	...
	protected ReflectiveMethodInvocation(
		...
		this.arguments = temp.spring.aop.AopProxyUtils.adaptArgumentsIfNecessary(method, arguments);
	...
	public Object proceed() throws Throwable {
		...
		if (interceptorOrInterceptionAdvice instanceof org.springframework.aop.framework.InterceptorAndDynamicMethodMatcher) {
			// Evaluate dynamic method matcher here: static part will already have
			// been evaluated and found to match.
			org.springframework.aop.framework.InterceptorAndDynamicMethodMatcher dm =
					(org.springframework.aop.framework.InterceptorAndDynamicMethodMatcher) interceptorOrInterceptionAdvice;
