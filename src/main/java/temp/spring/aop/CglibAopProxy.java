 ...
 * configured by an {@link temp.spring.aop.AdvisedSupport} object. This class is internal
...
class CglibAopProxy implements AopProxy, Serializable {
	...
	protected final temp.spring.aop.AdvisedSupport advised;
	 ...
	 */
	public CglibAopProxy(temp.spring.aop.AdvisedSupport config) throws org.springframework.aop.framework.AopConfigException {
		Assert.notNull(config, "AdvisedSupport must not be null");
		if (config.getAdvisors().length == 0 && config.getTargetSource() == temp.spring.aop.AdvisedSupport.EMPTY_TARGET_SOURCE) {
	...
	public Object getProxy(ClassLoader classLoader) {
		...
		try {
			...
			throw new org.springframework.aop.framework.AopConfigException("Could not generate CGLIB subclass of class [" +
	...
	private static class AdvisedDispatcher implements Dispatcher, Serializable {
		...
		private final temp.spring.aop.AdvisedSupport advised;

		public AdvisedDispatcher(temp.spring.aop.AdvisedSupport advised) {
	...
	private static class EqualsInterceptor implements MethodInterceptor, Serializable {
		...
		public EqualsInterceptor(temp.spring.aop.AdvisedSupport advised) {
			this.advised = advised;
		}
		...
		public Object intercept(Object proxy, Method method, Object[] args, MethodProxy methodProxy) {
			...
			if (other instanceof Factory) {
				...
				temp.spring.aop.AdvisedSupport otherAdvised = ((EqualsInterceptor) callback).advised;
	...
	private static class HashCodeInterceptor implements MethodInterceptor, Serializable {
		...
		public HashCodeInterceptor(temp.spring.aop.AdvisedSupport advised) {
			this.advised = advised;
		}
	...
	private static class DynamicAdvisedInterceptor implements MethodInterceptor, Serializable {
		...
		public DynamicAdvisedInterceptor(temp.spring.aop.AdvisedSupport advised) {
			this.advised = advised;
		}
	...
	private static class ProxyCallbackFilter implements CallbackFilter {
		...
		public ProxyCallbackFilter(temp.spring.aop.AdvisedSupport advised, Map<String, Integer> fixedInterceptorMap, int fixedInterceptorOffset) {
			this.advised = advised;
		...
		public int accept(Method method) {
			...
			if (!this.advised.isOpaque() && method.getDeclaringClass().isInterface() &&
					method.getDeclaringClass().isAssignableFrom(temp.spring.aop.Advised.class)) {
				if (logger.isDebugEnabled()) {
		...
		public boolean equals(Object other) {
			...
			temp.spring.aop.AdvisedSupport otherAdvised = otherCallbackFilter.advised;
