...
public class AspectJExpressionPointcut extends AbstractExpressionPointcut
	...
	public boolean matches(Method method, Class<?> targetClass, boolean beanHasIntroductions) {
		...
		if (shadowMatch.alwaysMatches()) {
			...
			// runtime subtype.
			org.springframework.aop.aspectj.RuntimeTestWalker walker = getRuntimeTestWalker(shadowMatch);
	...
	public boolean matches(Method method, Class<?> targetClass, Object... args) {
		...
		try {
			...
			if (pmi != null) {  // there is a current invocation
				org.springframework.aop.aspectj.RuntimeTestWalker originalMethodResidueTest = getRuntimeTestWalker(originalShadowMatch);
	...
	private org.springframework.aop.aspectj.RuntimeTestWalker getRuntimeTestWalker(ShadowMatch shadowMatch) {
		if (shadowMatch instanceof DefensiveShadowMatch) {
			return new org.springframework.aop.aspectj.RuntimeTestWalker(((DefensiveShadowMatch) shadowMatch).primary);
		}
		return new org.springframework.aop.aspectj.RuntimeTestWalker(shadowMatch);
	}
