 ...
 * Use a {@link org.springframework.aop.aspectj.annotation.LazySingletonAspectInstanceFactoryDecorator}
...
public class BeanFactoryAspectInstanceFactory implements MetadataAwareAspectInstanceFactory, Serializable {
	...
	public BeanFactoryAspectInstanceFactory(BeanFactory beanFactory, String name, Class<?> type) {
		...
		this.name = name;
		this.aspectMetadata = new org.springframework.aop.aspectj.annotation.AspectMetadata(type, name);
	}
