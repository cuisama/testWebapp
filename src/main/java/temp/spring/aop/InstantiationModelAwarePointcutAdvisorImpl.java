...
class InstantiationModelAwarePointcutAdvisorImpl
	...
	public InstantiationModelAwarePointcutAdvisorImpl(AspectJExpressionPointcut declaredPointcut,
                                                      Method aspectJAdviceMethod, org.springframework.aop.aspectj.annotation.AspectJAdvisorFactory aspectJAdvisorFactory,
	...
	private void determineAdviceType() {
		AspectJAnnotation<?> aspectJAnnotation =
				temp.spring.aop.AbstractAspectJAdvisorFactory.findAspectJAnnotationOnMethod(this.aspectJAdviceMethod);
	...
	private class PerTargetInstantiationModelPointcut extends DynamicMethodMatcherPointcut {
		...
		private PerTargetInstantiationModelPointcut(AspectJExpressionPointcut declaredPointcut,
			...
			if (aspectInstanceFactory instanceof org.springframework.aop.aspectj.annotation.LazySingletonAspectInstanceFactoryDecorator) {
