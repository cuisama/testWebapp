 ...
 * #construct(org.aopalliance.intercept.ConstructorInvocation)} method to modify the original
 ...
 * @author Rod Johnson
 */
public interface ConstructorInterceptor extends org.aopalliance.intercept.Interceptor {

	/**
	 * Implement this method to perform extra treatments before and
	 * after the construction of a new object. Polite implementations
	 * would certainly like to invoke {@link temp.spring.aop.Joinpoint#proceed()}.
	 * @param invocation the construction joinpoint
	 * @return the newly created object, which is also the result of
	 * the call to {@link temp.spring.aop.Joinpoint#proceed()}; might be replaced by
	 * the interceptor
