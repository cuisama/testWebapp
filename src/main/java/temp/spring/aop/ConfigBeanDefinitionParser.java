...
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
		...
		try {
			...
			if (pointcut instanceof BeanDefinition) {
				...
				parserContext.registerComponent(
						new org.springframework.aop.config.AdvisorComponentDefinition(advisorBeanName, advisorDef, (BeanDefinition) pointcut));
			}
	...
	private void parseAspect(Element aspectElement, ParserContext parserContext) {
		...
		try {
			...
			org.springframework.aop.config.AspectComponentDefinition aspectComponentDefinition = createAspectComponentDefinition(
	...
	private org.springframework.aop.config.AspectComponentDefinition createAspectComponentDefinition(
