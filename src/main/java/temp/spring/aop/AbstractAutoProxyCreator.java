 ...
 * {@link org.springframework.aop.framework.autoproxy.BeanNameAutoProxyCreator}, identifying the beans to be proxied via given names.
 *
...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	protected Object createProxy(
		...
		if (this.beanFactory instanceof ConfigurableListableBeanFactory) {
			temp.spring.aop.AutoProxyUtils.exposeTargetClass((ConfigurableListableBeanFactory) this.beanFactory, beanName, beanClass);
		}
	 ...
	 * <p>Checks the {@link temp.spring.aop.AutoProxyUtils#PRESERVE_TARGET_CLASS_ATTRIBUTE "preserveTargetClass" attribute}
	...
	protected boolean shouldProxyTargetClass(Class<?> beanClass, String beanName) {
		return (this.beanFactory instanceof ConfigurableListableBeanFactory &&
				temp.spring.aop.AutoProxyUtils.shouldProxyTargetClass((ConfigurableListableBeanFactory) this.beanFactory, beanName));
	}
