...
public abstract class Pointcuts {
	...
	public static Pointcut union(Pointcut pc1, Pointcut pc2) {
		return new org.springframework.aop.support.ComposablePointcut(pc1).union(pc2);
	}
	...
	public static Pointcut intersection(Pointcut pc1, Pointcut pc2) {
		return new org.springframework.aop.support.ComposablePointcut(pc1).intersection(pc2);
	}
