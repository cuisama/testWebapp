...
public interface AspectJAdvisorFactory {
	 ...
	 */
	List<Advisor> getAdvisors(temp.spring.aop.MetadataAwareAspectInstanceFactory aspectInstanceFactory);
	 ...
	 */
	Advisor getAdvisor(Method candidateAdviceMethod, temp.spring.aop.MetadataAwareAspectInstanceFactory aspectInstanceFactory,
	...
	Advice getAdvice(Method candidateAdviceMethod, AspectJExpressionPointcut expressionPointcut,
					 temp.spring.aop.MetadataAwareAspectInstanceFactory aspectInstanceFactory, int declarationOrder, String aspectName);
